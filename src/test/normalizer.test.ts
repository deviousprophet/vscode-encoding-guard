...
suite('normalizeEncoding', () => {
    ...
    // --- ISO-8859 family (VS Code identifier for -1 is iso88591, not latin1) ---
    test('latin1 → iso88591',        () => assert.strictEqual(normalizeEncoding('latin1'),        'iso88591'));
    test('latin-1 → iso88591',       () => assert.strictEqual(normalizeEncoding('latin-1'),       'iso88591'));
    test('ISO-8859-1 → iso88591',    () => assert.strictEqual(normalizeEncoding('ISO-8859-1'),    'iso88591'));
    test('iso88591 → iso88591',      () => assert.strictEqual(normalizeEncoding('iso88591'),      'iso88591'));
    test('iso-8859-1 → iso88591',    () => assert.strictEqual(normalizeEncoding('iso-8859-1'),    'iso88591'));
